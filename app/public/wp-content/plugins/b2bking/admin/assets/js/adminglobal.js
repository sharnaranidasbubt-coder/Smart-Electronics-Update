		...
		if ($('#b2bking_content_selector').length) {
			...
			$toggleButton.on('click', function(e) {
				...
				if (isTextMode) {
					...
					$('.b2bking_rule_label').eq(-1).show(); // Show "Search for products..." label
					...
					$('.b2bking_rule_label').eq(-1).hide(); // Hide "Search for products..." label
					$('#b2bking_rule_select_applies_replaced').show();
					$('.b2bking_product_variation_ids_title').show();
